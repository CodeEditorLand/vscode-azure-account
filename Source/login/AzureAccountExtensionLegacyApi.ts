...
import type * as legacyTypes from "../azure-account.legacy.api";
import type { OSName } from "../cloudConsole/cloudConsole";
import type { AzureAccountExtensionApi } from "./AzureAccountExtensionApi";
