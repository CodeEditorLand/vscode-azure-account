...
import {
	DebugHttpStringifier,
	type HttpStringifier,
	SimpleHttpStringifier,
	TraceHttpStringifier,
} from "./stringifyHttp";
...
export class HttpLogger<TRequest, TResponse>
	implements HttpLogger<TRequest, TResponse>
{
	constructor(
