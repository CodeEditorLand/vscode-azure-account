...
import type { HttpOperationResponse, WebResourceLike } from "@azure/ms-rest-js";
import type {
	HttpNormalizer,
...
export class MsRestNormalizer
	implements HttpNormalizer<WebResourceLike, HttpOperationResponse>
{
