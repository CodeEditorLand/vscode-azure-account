...
-   When signing into a different cloud than previously used, shows a prompt to
    enter tenant id.
...
-   Let the user pick the tenant to open a Cloud Shell for
    ([#33](https://github.com/Microsoft/vscode-azure-account/issues/33))
